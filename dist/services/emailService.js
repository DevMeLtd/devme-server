...
exports.sendAdminNotification = exports.sendStatusUpdateEmail = exports.sendApplicationConfirmation = exports.sendConfirmationEmail = void 0;
...
const sendStatusUpdateEmail = (options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!statusInfo)
        return; // Only send for shortlisted or accepted
    const mailOptions = {
        from: process.env.EMAIL_USER,
        to: options.email,
...
const sendAdminNotification = (options) => __awaiter(void 0, void 0, void 0, function* () {
    const mailOptions = {
        from: process.env.EMAIL_USER,
